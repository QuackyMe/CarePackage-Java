                ...
                <div class="col-12 col-lg-5">
                    <div class="entry-content">
                        ...
                        <ul class="contact-info p-0">
                            <li><i class="fa fa-phone"></i><span>+639498209116</span></li>
                            <li><i class="fa fa-envelope"></i><span>contact@carepackage.com</span></li>
                            <li><i class="fa fa-map-marker"></i><span>333 Sen. Gil J. Puyat Ave, Makati, 1200 Metro Manila</span></li>
                        </ul>
                    </div>
                </div><!-- .col -->
