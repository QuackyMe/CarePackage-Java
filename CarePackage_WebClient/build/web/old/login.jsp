...
<header class="site-header">
   ...
   <div class = "login-form">
        <form id = "register">
            <input type="text" name="uid" id="text" placeholder="Enter User ID"><br><br>
            <input type="text" name="password" id="text" placeholder="Enter Password"><br><br>
            <input class="btn gradient-bg" type="submit" value="Login">
        </form>
   </div>
