	...
	java.lang.String result = port.saveDonate(name, email, amount);
	out.println(result);
    } catch (Exception ex) {
...
<html lang="en" >
    ...
    <body>
        ...
        <div class="payment-title">
            <h1>Your kindness will feed the many</h1>
        </div>
        ...
        <div class="form-container">      
            <form action="index.jsp" method="POST">
                ...
                <div class="field-container">
                    ...
                    <input name="securitycode" id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric"> <br>
                    <object align="right"> <input type="SUBMIT" value='Send Payment' class="button blue"> </object>
                </div>
            </form>
